...
public class AiPlayer : PlayerBase
{
   ...
   // public int winLEngth = 0;
    ...
    public override void PassMove(int[,] data, int playerSign, int opponentSign)
    {
        ...
        StartCoroutine(pauseTiMakeMove( data,  playerSign,  opponentSign));
    ...
    IEnumerator pauseTiMakeMove(int[,] data, int playerSign, int opponentSign)
    {

        yield return new WaitForFixedUpdate();
        int[,] newBoard = MonteCarlo.MCST.findNextMove(data, playerSign, opponentSign,  100 * data.GetLength(0) * data.GetLength(1));
        move = MonteCarlo.MCST.findDifference(data, newBoard);
